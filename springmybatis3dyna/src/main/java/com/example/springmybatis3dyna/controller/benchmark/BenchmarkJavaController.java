...
@RestController
@RequestMapping("/rest/v1/java/benchmark")
public class BenchmarkJavaController {
    ...
    static class Benchmark {
        String version = "MyBatis3Java#" + ITERATIONS;
        long findAll;
        long findBy;
        long inserts;
        long updates;
    ...
    public Benchmark benchmark() {
        ...
        insertsTime.stop();
        System.out.println("[MyBatis3Java][" + ITERATIONS + "]Insert Time: " + insertsTime.getTotalTimeMillis());
        ...
        findAllTime.stop();
        System.out.println("[MyBatis3Java][" + ITERATIONS + "]FindAll Time: " + findAllTime.getTotalTimeMillis());
        ...
        findByTime.stop();
        System.out.println("[MyBatis3Java][" + ITERATIONS + "]FindBy Time: " + findByTime.getTotalTimeMillis());
        ...
        updatesTime.stop();
        System.out.println("[MyBatis3Java][" + ITERATIONS + "]Updates Time: " + updatesTime.getTotalTimeMillis());
        ...
        deletesTime.stop();
        System.out.println("[MyBatis3Java][" + ITERATIONS + "]Delete Time: " + deletesTime.getTotalTimeMillis());
