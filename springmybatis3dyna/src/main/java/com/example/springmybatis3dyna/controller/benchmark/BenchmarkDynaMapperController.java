...
@RestController
@RequestMapping("/rest/v1/dynamapper/benchmark")
public class BenchmarkDynaMapperController {
    ...
    static class Benchmark {
        String version = "MyBatis3DynaMapper#" + ITERATIONS;
        long findAll;
        long findBy;
        long inserts;
        long updates;
    ...
    public Benchmark benchmark() {
        ...
        insertsTime.stop();
        System.out.println("[MyBatis3DynaMapper][" + ITERATIONS + "]Insert Time: " + insertsTime.getTotalTimeMillis());
        ...
        findAllTime.stop();
        System.out.println("[MyBatis3DynaMapper][" + ITERATIONS + "]FindAll Time: " + findAllTime.getTotalTimeMillis());
        ...
        findByTime.stop();
        System.out.println("[MyBatis3DynaMapper][" + ITERATIONS + "]FindBy Time: " + findByTime.getTotalTimeMillis());
        ...
        updatesTime.stop();
        System.out.println("[MyBatis3DynaMapper][" + ITERATIONS + "]Updates Time: " + updatesTime.getTotalTimeMillis());
        ...
        deletesTime.stop();
        System.out.println("[MyBatis3DynaMapper][" + ITERATIONS + "]Delete Time: " + deletesTime.getTotalTimeMillis());
