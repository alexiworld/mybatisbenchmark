...
@RestController
@RequestMapping("/rest/v1/benchmark/xml")
public class BenchmarkXmlController {
    ...
    static class Benchmark {
        String version = "MyBatis3Xml#" + ITERATIONS;
        long findAll;
        long findBy;
        long inserts;
        long updates;
    ...
    public Benchmark benchmark() {
        ...
        insertsTime.stop();
        System.out.println("[MyBatis3Xml][" + ITERATIONS + "]Insert Time: " + insertsTime.getTotalTimeMillis());
        ...
        findAllTime.stop();
        System.out.println("[MyBatis3Xml][" + ITERATIONS + "]FindAll Time: " + findAllTime.getTotalTimeMillis());
        ...
        findByTime.stop();
        System.out.println("[MyBatis3Xml][" + ITERATIONS + "]FindBy Time: " + findByTime.getTotalTimeMillis());
        ...
        updatesTime.stop();
        System.out.println("[MyBatis3Xml][" + ITERATIONS + "]Updates Time: " + updatesTime.getTotalTimeMillis());
        ...
        deletesTime.stop();
        System.out.println("[MyBatis3Xml][" + ITERATIONS + "]Delete Time: " + deletesTime.getTotalTimeMillis());
